...
async def JP1(ctx):  # <--- Corrigido aqui!
    ...
    print(f"Painel de Cadastro de Streamers enviado por {ctx.author} no canal {ctx.channel}.")
    print(f"comandos vinculados ao bot {{commands = [cmd.name for cmd in bot.commands]}} estão funcionando normalmente.") 
